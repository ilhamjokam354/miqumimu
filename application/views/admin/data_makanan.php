<div class="container-fluid">
  <div class="row">
      <div class="col-md-6"> 
        <button class="btn btn-sm btn-success mb-3" data-toggle="modal" data-target="#mDataGallery"><i class="fas fa-plus fa-sm"></i> Tambah Makanan</button>

      </div>
      <div class="col-md-6"> 
        <?php echo form_open('mmadmins/data_makanan/search') ?>
    ...
    <table class="table table-bordered table-responsive-sm table-hover">
        ...
        <tr>
            <td><?php echo $no++?></td>
            <td><img src="<?= base_url()?>uploads/produk/makanan/<?php echo $key->gambar?>" width="200" height="100" alt="Gambar Produk"></td>
            ...
            <td onclick="return confirm('Apakah Anda Yakin Ingin Mengubah!')"><?php echo anchor('mmadmins/data_makanan/edit/'.$key->id_makanan, '<div class="btn btn-sm btn-primary" data-toggle="tooltip" data-placement="bottom" title="Update"> <i class="fa fa-edit" ></i></div>')?></td>
            <td onclick="return confirm('Apakah Anda Yakin Ingin Menghapus!')"><?php echo anchor('mmadmins/data_makanan/hapus/'.$key->id_makanan, '<div class="btn btn-sm btn-danger" data-toggle="tooltip" data-placement="bottom" title="Hapus"><i class="fa fa-trash"></i> </div>')?></td>
        </tr>
        <?php endforeach?>
    </table>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="<?php echo base_url().'mmadmins/data_makanan/tambahData'?>" method="post" enctype="multipart/form-data">
