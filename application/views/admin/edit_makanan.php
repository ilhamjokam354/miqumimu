<div class="container-fluid">
    <h3><i class="fas fa-edit"></i> Edit Makanan</h3>
    <?php foreach ($makanan as $key):?>
    <form action="<?php echo base_url().'mmadmins/data_makanan/update'?>" method="post" enctype="multipart/form-data">
    ...
    <div class="form-group">
        ...
        <input type="hidden" name="id" value="<?= $key->id_makanan?>">
    </div>
